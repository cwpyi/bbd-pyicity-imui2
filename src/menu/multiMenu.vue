<template>
    <div class="_multi-menu" ref="root">
        ...
        <div class="spread _bg" v-show="isSpread" @click="cancel" ref="shadow"></div>
        <transition name="top">
        <div class="spread" v-show="isSpread" ref="spread">
            <template v-if="hasSpread()">
                <div v-for="level in columns" class="_items" :style="getColor(level-1)">
                    <div class="_item" v-for="(item, index) in spreadList[level-1]" 
